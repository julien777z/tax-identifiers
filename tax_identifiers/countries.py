...
class Country(BaseEnum):
    ...
    def from_string(cls, value: str) -> "Country":
        """Normalize a country code or name (for example 'US' or 'United States') to a Country."""

        return cls(normalize_country_code(value))

    @classmethod
    def _missing_(cls, value: object) -> "Country | None":
        """Resolve names, alpha-3 codes, and mixed-case inputs to a member via normalization."""
